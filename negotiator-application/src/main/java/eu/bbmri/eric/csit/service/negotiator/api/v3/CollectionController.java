...
import eu.bbmri.eric.csit.service.negotiator.repository.BiobankRepository;
...
public class CollectionController {
  ...
  Biobank retrieveBiobank(@PathVariable Long id) {
    return biobankRepository
        .findById(id)
        .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Biobank not found"));
  }
}
