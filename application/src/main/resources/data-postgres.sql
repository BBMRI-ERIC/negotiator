...
values(1, 'INTERNAL', 'dev_admin@negotiator.dev', 'admin', 'admin', 'true', null, null);

insert into person
  (id, type, auth_email, auth_name, auth_subject, is_admin, organization, person_image)
values(2, 'EXTERNAL', 'researcher@negotiator.dev', 'researcher', 'researcher', 'false', null, null);
