...
- **No seed, demo or test SQL exists anywhere.** 50 `V*.sql` migrations in `backend/src/main/resources/db/migration/`, zero fixtures. Testcontainers 1.21.1 + Flyway 11.10.0 present; container setup at `backend/src/test/java/eu/bbmri_eric/negotiator/config/PostgresContainerManager.java`.
