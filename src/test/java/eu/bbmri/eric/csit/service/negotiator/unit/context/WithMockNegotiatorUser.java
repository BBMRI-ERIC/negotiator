...
/**
 * Annotation to be used in unit tests similar to standard @WithMockUser but tailored on Negotiator
 * User. It includes properties of a Person necessary in the authn/authz process
 */
