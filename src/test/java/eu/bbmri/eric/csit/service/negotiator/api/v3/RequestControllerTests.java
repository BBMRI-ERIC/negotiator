...
public class RequestControllerTests {
  ...
  public void testCreate_Ok() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.redirectUrl", containsString("http://localhost/gui/negotiation")))
  ...
  public void testGetAll_Ok() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$[0].redirectUrl", containsString("http://localhost/gui/negotiation")))
