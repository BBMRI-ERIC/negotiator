...
import eu.bbmri.eric.csit.service.negotiator.api.controller.v3.OrganizationController;
...
public class OrganizationModelAssembler
  ...
  public @NonNull EntityModel<OrganizationDTO> toModel(@NonNull OrganizationDTO entity) {
    return EntityModel.of(entity)
        .add(
            linkTo(methodOn(OrganizationController.class).findById(entity.getId())).withSelfRel(),
