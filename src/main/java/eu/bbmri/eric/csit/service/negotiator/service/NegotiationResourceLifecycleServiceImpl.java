...
@Service
@CommonsLog
public class NegotiationResourceLifecycleServiceImpl implements NegotiationResourceLifecycleService{
    ...
    private StateMachineService<NegotiationResourceState, NegotiationResourceEvent> springNegotiationResourceStateMachineService;
    @Override
    ...
    @Override
    public NegotiationResourceState getCurrentState(String negotiationId, String resourceId) throws EntityNotFoundException {
    ...
    @Override
    public Set<NegotiationResourceEvent> getPossibleEvents(String negotiationId, String resourceId) throws EntityNotFoundException {
        ...
        StateMachine<NegotiationResourceState, NegotiationResourceEvent> stateMachine = this.springNegotiationResourceStateMachineService.acquireStateMachine(
                machineId);
    ...
    @Override
    public NegotiationResourceState sendEvent(String negotiationId, String resourceId, NegotiationResourceEvent negotiationEvent) throws WrongRequestException, EntityNotFoundException {
        StateMachine<NegotiationResourceState, NegotiationResourceEvent> stateMachine = this.springNegotiationResourceStateMachineService.acquireStateMachine(
                createMachineId(negotiationId, resourceId), true);
        StateMachineEventResult<NegotiationResourceState, NegotiationResourceEvent> newState = stateMachine.sendEvent(
