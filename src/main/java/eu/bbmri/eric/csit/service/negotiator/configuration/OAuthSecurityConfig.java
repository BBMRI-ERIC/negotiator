...
public class OAuthSecurityConfig {
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    ...
    http
        ...
        .antMatchers(HttpMethod.POST, "/directory/create_query", "/v3/requests/**").hasAuthority("EXT_SERV")
        .and()
        .authorizeHttpRequests()
        .antMatchers(HttpMethod.PUT, "/directory/create_query", "/v3/requests/**").hasAuthority("EXT_SERV")
        .and()
        .authorizeHttpRequests()
