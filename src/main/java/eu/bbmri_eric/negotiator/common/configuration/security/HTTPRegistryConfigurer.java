...
public class HTTPRegistryConfigurer {
  ...
  public void configure(
    ...
    auth.requestMatchers(mvc.pattern(HttpMethod.GET, "/v3/negotiations"))
        ...
        .authenticated()
        .requestMatchers(mvc.pattern(HttpMethod.DELETE, "/v3/users/*/networks/**"))
        .hasRole("ADMIN")
        .requestMatchers(mvc.pattern(HttpMethod.PATCH, "/v3/users/*/networks"))
        .hasRole("ADMIN")
        ...
        .hasRole("ADMIN")
        .requestMatchers(mvc.pattern(HttpMethod.POST, "/v3/organizations"))
        .hasAnyRole("ADMIN", "RESOURCE_MANAGER")
