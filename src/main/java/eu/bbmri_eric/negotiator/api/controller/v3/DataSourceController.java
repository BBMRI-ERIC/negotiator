...
public class DataSourceController {
  ...
  DataSourceDTO add(
      @Validated(ValidationGroups.Create.class) @RequestBody DataSourceCreateDTO request) {
  ...
  DataSourceDTO update(
      ...
      @Validated(ValidationGroups.Update.class) @RequestBody DataSourceCreateDTO request) {
