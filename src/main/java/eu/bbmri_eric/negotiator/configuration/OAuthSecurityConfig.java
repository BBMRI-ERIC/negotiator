...
import eu.bbmri_eric.negotiator.configuration.auth.JwtAuthenticationConverter;
import eu.bbmri_eric.negotiator.configuration.auth.NegotiatorUserDetailsService;
