...
public final class AttachmentTestHelper {
    ...
    private byte[] loadResourceOrDefault(String path, Supplier<byte[]> defaultSupplier) throws IOException {
    ...
    public byte[] loadTestDocxFile() throws IOException {
        return loadResourceOrDefault("/test-documents/test.docx", AttachmentTestHelper::createMinimalDocxBytes);
    }

    public byte[] loadTestDocFileValid() throws IOException {
        return loadResourceOrDefault("/test-documents/test-valid.doc", AttachmentTestHelper::createMinimalDocBytes);
    }

    public byte[] loadTestDocFile() throws IOException {
        return loadResourceOrDefault("/test-documents/test.doc", AttachmentTestHelper::createMinimalDocBytes);
    }
    ...
    public byte[] createValidXlsxBytes() throws IOException {
        return loadResourceOrDefault("/test-documents/test.xlsx", () -> {
            try {
