    ...
    public StateMachineModel<String, String> build(String machineId) {
        ...
        for (Transition transition : transitions) {
            ...
            if (sourceName != null && targetName != null) {
                // TransitionData(source, target, state, event, period, count, actions, guard, kind, securityRule, name)
                TransitionData<String, String> transitionData = new TransitionData<>(
                    sourceName,
                    targetName,
                    transition.getName()
                );
