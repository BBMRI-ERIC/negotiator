...
public final class TransitionEvaluator {
  ...
  // Written out rather than generated by Lombok's @RequiredArgsConstructor. The paragraph above
  // asks a reader to look at this constructor and see that no repository, EntityManager or Spring
  // Data type is on it. A generated constructor gives them nothing to look at.
