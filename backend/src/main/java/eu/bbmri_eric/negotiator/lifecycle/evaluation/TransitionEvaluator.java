 ...
 *
 * <p><b>Look at what it depends on.</b> There is no repository, no {@code EntityManager} and no
 ...
 *
 * <p>Its one dependency is {@link InformationRequirementSatisfaction}, and it is an interface for
 * exactly that reason: whether a form has been submitted is the single question about a move that
 * cannot be handed in on the context, so it goes behind a port instead of behind a query.
 *
