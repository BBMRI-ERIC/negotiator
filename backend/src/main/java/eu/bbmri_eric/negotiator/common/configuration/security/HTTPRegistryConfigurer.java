...
public class HTTPRegistryConfigurer {
  ...
  public void configure(
    ...
    auth.requestMatchers(mvc.pattern(HttpMethod.GET, "/v3/negotiations"))
        ...
        .authenticated()
        .requestMatchers(mvc.pattern("/v3/emails"))
        .hasRole("ADMIN")
        .requestMatchers(mvc.pattern("/v3/state-machines/**"))
        .authenticated()
        .requestMatchers(mvc.pattern("/v3/emails/**"))
        .hasRole("ADMIN")
        .requestMatchers(mvc.pattern("/v3/templates/**"))
        .hasRole("ADMIN")
        .requestMatchers(mvc.pattern("/v3/users/roles"))
        .authenticated()
        .requestMatchers(mvc.pattern("/v3/users"))
        .hasAnyRole("ADMIN", "RESOURCE_MANAGER", "AUTHORIZATION_MANAGER")
        .requestMatchers(mvc.pattern("/v3/users/*"))
        .hasAnyRole("ADMIN", "RESOURCE_MANAGER", "AUTHORIZATION_MANAGER")
        ...
        .hasAnyRole("ADMIN", "RESOURCE_MANAGER")
        .requestMatchers(mvc.pattern(HttpMethod.PATCH, "/v3/organizations/**"))
        .hasAnyRole("ADMIN", "RESOURCE_MANAGER")
        ...
        .hasRole("ADMIN")
        .requestMatchers(mvc.pattern("/v3/users/*/notifications"))
        .authenticated()
        .requestMatchers(mvc.pattern("/v3/notifications/*"))
        .authenticated()
