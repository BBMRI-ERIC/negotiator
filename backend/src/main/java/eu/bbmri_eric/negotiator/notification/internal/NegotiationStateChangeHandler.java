...
class NegotiationStateChangeHandler implements NotificationStrategy<NegotiationStateChangeEvent> {
    ...
    public NegotiationStateChangeHandler(ResearcherNotificationService researcherNotificationService, AdminNotificationService adminNotificationService, RepresentativeNotificationService representativeNotificationService) {
    ...
    public void notify(NegotiationStateChangeEvent event) {
        switch (event.getChangedTo()){
            ...
            case IN_PROGRESS -> representativeNotificationService.notifyAboutANewNegotiation(event.getNegotiationId());
        }
    }
}
