...
class NotificationServiceImpl implements NotificationService {
    ...
    NotificationServiceImpl(
            NotificationRepository notificationRepository, ApplicationEventPublisher eventPublisher, ModelMapper modelMapper) {
    ...
    public List<NotificationDTO> createNotifications(@NotNull NotificationCreateDTO dto) {
        ...
        dto.getUserIds().forEach(id -> {
            Notification notification =
                    notificationRepository.save(new Notification(id, dto.getTitle(), dto.getBody(), dto.getNegotiationId()));
