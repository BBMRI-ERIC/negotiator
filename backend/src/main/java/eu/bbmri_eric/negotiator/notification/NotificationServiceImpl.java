...
public class NotificationServiceImpl implements NotificationService {
  ...
  public Notification createNotification(Person recipient, String title, String body) {
    Notification notification =
        notificationRepository.save(new Notification(recipient.getId(), title, body));
  ...
  public Notification createNotification(
      Person recipient, String title, String body, String negotiationId) {
    // TODO: Fix use of Negotiation Id
    Notification notification =
        notificationRepository.save(
            new Notification(recipient.getId(), negotiationId, title, body));
    eventPublisher.publishEvent(new NewNotificationEvent(this, notification.getId()));
    return notification;
  }
}
