CREATE TABLE negotiation_collaborator_link
(
    negotiation_id   VARCHAR(255) NOT NULL,
    person_id BIGINT       NOT NULL,
    CONSTRAINT pk_negotiation_collaborator_link PRIMARY KEY (negotiation_id, person_id)
);

ALTER TABLE negotiation_collaborator_link
