    ...
    <div class="row">
      ...
      >
        ...
        <div class="text-center">
          ...
          <a href="https://github.com/BBMRI-ERIC/negotiator" :style="{'color': uiConfiguration?.loginLinksColor}">BBMRI-ERIC
            Negotiator</a>
          ...
          <a href="https://github.com/BBMRI-ERIC/negotiator/blob/master/LICENSE"
             :style="{'color': uiConfiguration?.loginLinksColor}">(license: AGPLv3)</a>
        </div>
