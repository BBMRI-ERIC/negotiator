...
const negotiationSubmissionDateStep = {
...
const negotiationMessagingStep = {
...
export function useTourSteps(tourName, props = {}) {
  ...
  const tourSteps = {
    ...
    negotiationTour: [
      ...
      negotiationBodyStep,
      negotiationAuthorStep,
      negotiationIdStep,
      negotiationSubmissionDateStep,
      negotiationStatusStep,
      negotiationActionsStep,
      negotiationDownloadStep,
      negotiationMessagingStep,
    ],
    filterSortTour: [
      sortStep,
      sortByStep,
