...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      component: AdminSettingsPage,
      props: { activeNavItemIndexProps: 1, isAddWebhookVisible: true },
      meta: { isPublic: false, middleware: [hasUser] },
      beforeEnter: checkAccess(ROLES.ADMINISTRATOR),
    },
    {
      ...
      component: AdminSettingsPage,
      props: { activeNavItemIndexProps: 1, isEditWebhookVisible: true },
      meta: { isPublic: false, middleware: [hasUser] },
      beforeEnter: checkAccess(ROLES.ADMINISTRATOR),
    },
    {
      ...
      component: AdminSettingsPage,
      props: { activeNavItemIndexProps: 5, typeAccessForm: 'Create', isAccessFormVisible: true },
      meta: { isPublic: false, middleware: [hasUser] },
      beforeEnter: checkAccess(ROLES.ADMINISTRATOR),
    },
    {
      ...
      component: AdminSettingsPage,
      props: { activeNavItemIndexProps: 5, typeAccessForm: 'Edit', isAccessFormVisible: true },
      meta: { isPublic: false, middleware: [hasUser] },
      beforeEnter: checkAccess(ROLES.ADMINISTRATOR),
    },
    {
      ...
      component: AdminSettingsPage,
      props: { activeNavItemIndexProps: 5, typeAccessForm: 'Duplicate', isAccessFormVisible: true },
      meta: { isPublic: false, middleware: [hasUser] },
      beforeEnter: checkAccess(ROLES.ADMINISTRATOR),
    },
    {
